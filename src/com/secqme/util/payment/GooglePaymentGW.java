 ...
 * @author coolboykl
 */
public class GooglePaymentGW implements PaymentGateway {

    private static final Logger myLog = Logger.getLogger(GooglePaymentGW.class);
    private PaymentGWVO gwVO = null;
    private PaymentHelper paymentHelper = null;

    public GooglePaymentGW() {
        // Empty Constructor 
    }

    public void initPaymentGW(PaymentGWVO gwVO, PaymentHelper pymUtil) {
        myLog.debug("Initializing Google Payment GW:" + gwVO.getDescription());
        this.gwVO = gwVO;
