...
***************************************************/
	...
	if( is_tablet() ){
		$(".img-container").toggle(
			  function () {
				$(this).find("ul li a.view").click(function(){
					var single_url = $(this).attr("href");
					window.open(single_url, "_self");
				})
				$(this).find(".item-img").fadeTo(250, 0.8);
				$(this).find(".item-info-overlay").fadeTo(250, 0.8);
				$(this).find("ul").fadeTo(250, 1);
			  }, 
			  function () {
				$(this).find(".item-img").fadeTo(250, 1.0);
				$(this).find(".item-info-overlay").fadeTo(250, 0.0);
				$(this).find("ul").fadeTo(250, 0);
			  }
			)
		...
		var $container = $('#thumbs');
		  $container.isotope({
			...
			$(".img-container").each(function(e){
				if ($(this).find(".item-info-overlay").size() < 1) $(this).find(".item-img").after('<div class="item-info-overlay"></div>');
				var img_cont_width = $(this).parent().css("width");
			    $(this).css("width", img_cont_width).css("float", "left");
				var img_h = parseInt($(this).find(".item-img img").height());
				$(this).find(".item-info-overlay").css("height", img_h + "px");
				var cont_h = $(this).height();
				var cont_w = $(this).width();
				var icon_w = parseInt( $(this).find("ul a").css("width") );
				var icon_h = parseInt( $(this).find("ul a").css("height") );
				var ul_w = $(this).find("ul").children().size() * icon_w;
				var ul_h = icon_h;
				var ul_margin_r = parseInt((cont_w - ul_w) / 2);
				$(this).find("ul").css("left", ul_margin_r + "px");
				var ul_margin_t = parseInt((cont_h - ul_h) / 2);
				$(this).find("ul").css("top", ul_margin_t + "px");
			})
